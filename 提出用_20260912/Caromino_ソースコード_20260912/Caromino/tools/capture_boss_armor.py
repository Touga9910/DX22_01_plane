...
def game(label, case, build, boss=(0,20), configure=None, extra=(), resume=False):
    ...
    exe=h.PROJECT.parent/'x64/Debug/Caromino.exe'
    env=dict(os.environ, Caromino_TEST_PREDICTION='1', Caromino_TEST_RENDER_HZ=os.environ.get('Caromino_TEST_RENDER_HZ','60'))

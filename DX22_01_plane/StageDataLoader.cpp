...
namespace
{
    ...
    )
    {
        ...
        if (!file.is_open())
        {
            std::cout << "Enemy Master JSON‚ðŠJ‚¯‚Ü‚¹‚ñ‚Å‚µ‚½: "
                << filePath << std::endl;
            return enemyMap;
        }
        ...
        {
            std::cout << "Enemy Master JSON‚Ì“Ç‚Ýž‚Ý‚ÉŽ¸”s‚µ‚Ü‚µ‚½: "
                << filePath << std::endl;
...
)
{
    ...
    if (!file.is_open())
    {
        std::cout << "Stage JSON‚ðŠJ‚¯‚Ü‚¹‚ñ‚Å‚µ‚½: "
    ...
    try
    {
        ...
        if (root.contains("enemySpawns") && root["enemySpawns"].is_array())
        {
            for (const auto& spawnJson : root["enemySpawns"])
            {
                ...
                {
                    std::cout << "“GID‚ªenemy_data.json‚É‘¶Ý‚µ‚Ü‚¹‚ñ: "
                        << enemyId << std::endl;
                    continue;
                }
    ...
    {
        std::cout << "Stage JSON‚Ì“Ç‚Ýž‚Ý‚ÉŽ¸”s‚µ‚Ü‚µ‚½: "
            << stageFilePath << std::endl;
        std::cout << e.what() << std::endl;
    }

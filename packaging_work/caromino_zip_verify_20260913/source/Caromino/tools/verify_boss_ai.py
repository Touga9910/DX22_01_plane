...
def main():
    ...
    tracked=[p/n for n in ('GameBossAI.cpp','Game.h','GameAutoPlay.cpp','GameMcpBridge.cpp','BallShotPrediction.cpp','BallShotPrediction.h','Caromino.vcxproj')]
    ...
    manifest=dict(final_exe_sha256=digest(p.parent/'x64/Debug/Caromino.exe'),
